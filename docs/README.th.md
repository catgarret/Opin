...
Opin เป็นส่วนขยายของเบราว์เซอร์ที่ช่วยให้คุณเปิดภาพต้นฉบับความละเอียดสูงที่อยู่เบื้องหลังพินใด ๆ ของ Pinterest ได้
โดยจะเพิ่มปุ่มไว้ข้าง ๆ ปุ่ม **บันทึก (Save)** ของ Pinterest คลิกแล้วภาพต้นฉบับขนาดเต็มจะเปิดขึ้นในแท็บใหม่
...
ซอร์สโค้ดของส่วนขยายไม่ได้เผยแพร่ต่อสาธารณะ
โปรดติดตั้ง Opin ผ่านร้านค้าส่วนขยายเบราว์เซอร์อย่างเป็นทางการที่ระบุไว้ด้านล่างเท่านั้น
...
Opin ไม่เก็บหรือจัดเก็บข้อมูลส่วนบุคคลใด ๆ และไม่เชื่อมต่อกับเซิร์ฟเวอร์ภายนอก
อ่านรายละเอียดได้ที่[นโยบายความเป็นส่วนตัว](PRIVACY.th.md)
