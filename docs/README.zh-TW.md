...
![Opin — 檢視 Pinterest 原始圖片](../images/cover-zh-TW.png)

Opin 是一款瀏覽器擴充功能，可讓你開啟任何 Pinterest 圖釘背後的高解析度原始圖片。
它會在 Pinterest 的**儲存**按鈕旁新增一個按鈕，點擊即可在新分頁中開啟完整尺寸的原圖。
...
![以原始尺寸下載](../images/detail-01-zh-TW.png)
![點擊 Opin 按鈕](../images/detail-02-zh-TW.png)
![在本機安全執行](../images/detail-03-zh-TW.png)

## 隱私

Opin 不會收集或儲存任何個人資料，也從不與外部伺服器通訊。
詳見[隱私權政策](PRIVACY.zh-TW.md)。
...
[MIT 授權條款](../LICENSE)僅適用於本儲存庫中公開的文件及其他檔案。
不適用於 Opin 瀏覽器擴充功能及其原始碼。
